...
// src/shared/list.tsx (or wherever your list.tsx is located)
import { type DoctorAgent } from "@/config/schema"; // Ensure this import path is correct for your schema file

export const AIDoctorAgents: (DoctorAgent & { subscriptionRequired: boolean })[] = [
    {
        id: 1,
